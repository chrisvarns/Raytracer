...
box::box(const vec3& p0, const vec3& p1, material* ptr)
{
	...
	list.hitables.push_back(new xy_rect(p0.x, p1.x, p0.z, p1.z, p1.y, ptr));
	list.hitables.push_back(new flip_normals(new xy_rect(p0.x, p1.x, p0.z, p1.z, p0.y, ptr)));
	list.hitables.push_back(new xy_rect(p0.y, p1.y, p0.z, p1.z, p1.x, ptr));
	list.hitables.push_back(new flip_normals(new xy_rect(p0.y, p1.y, p0.z, p1.z, p0.x, ptr)));
}
